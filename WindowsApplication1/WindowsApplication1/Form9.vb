Public Class Form9
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Try
            ...
            TextBox5.Text = bb
            TextBox6.Text = cc
            sqlquery.CommandText = "INSERT INTO saleinfo(CustCode,CustName,TransDate,details,BillAmt,Gst,TotalBill)VALUES(@CustCode,@CustName,@TransDate,@details,@BillAmt,@Gst,@TotalBill)"
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        Try
            ...
            If ComboBox1.Text = "5" Then
                sqlquery.CommandText = "UPDATE info set StockOut=StockOut+5,StockInHand=StockInHand-5 where code=@code"
            End If
            If ComboBox1.Text = "15" Then
                sqlquery.CommandText = "UPDATE info set StockOut=StockOut+15,StockInHand=StockInHand-15 where code=@code"
            End If
            If ComboBox1.Text = "10" Then
                sqlquery.CommandText = "UPDATE info set StockOut=StockOut+10,StockInHand=StockInHand-10 where code=@code"
            End If
            If ComboBox1.Text = "20" Then
                sqlquery.CommandText = "UPDATE info set StockOut=StockOut+20,StockInHand=StockInHand-20 where code=@code"
            End If
            If ComboBox1.Text = "50" Then
                sqlquery.CommandText = "UPDATE info set StockIOut=StockOut+50,StockInHand=StockInHand-50 where code=@code"
            End If
